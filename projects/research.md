...
I was fortunate to be co-author on a couple other works during this time, including [Direct Nash Optimization](https://arxiv.org/abs/2404.03715) and [Adapting LLM Agents Through Communication](https://openreview.net/forum?id=wOelVq8fwL). These projects were incredibly fun to help with. I would highly recommend reading those works for yourself!
...
This, by far, is the paper I'm most excited about from my time at UC.It's [available here](https://ieeexplore.ieee.org/abstract/document/9145735).
